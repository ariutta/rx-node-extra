...
module.exports = function(Rx, RxNode) {
  ...
  function ask(source, getPromptSet, createIterable) {
    ...
    .doOnError(function(err) {
      err.message = (err.message || '') + 'Error in ask';
      throw err;
    });
  }

  RxNode.prototype.ask = function(getPromptSet, createIterable) {
    var source = this;
    return ask(source, getPromptSet, createIterable);
  };

  RxNode.ask = function ask(getPromptSet) {
